...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Demonstrate model results')
    parser.add_argument(
...
def main():
    ...
    for i in xrange(num_images):
        ...
        cls_boxes, cls_segms, cls_keyps = im_detect_all(model, im, timers=timers)
