...
if __name__ == '__main__':
    ...
    elif args.dataset == "triangle_2017_train":
        cfg.TEST.DATASETS = ('triangle_2017_train',)
        cfg.MODEL.NUM_CLASSES = 81
    elif args.dataset == "coco2014":
        cfg.TEST.DATASETS = ('coco_2014_val',)
        cfg.MODEL.NUM_CLASSES = 81
    elif args.dataset == "coco2014mini":
    ...
    '''This is from core.test_engine, feel like this is just a gpu-efficient option script'''
    run_inference(
        args,
